% Simulates the effects of feedback to MCs during odor presentation
...
mFeedback(FB_cells) = normrnd(200,20,length(FB_cells),1); %100 and 10 originally
...
for i = 1:numOdors
    ...
    fname = sprintf('MCFeedbackResults.mat');
