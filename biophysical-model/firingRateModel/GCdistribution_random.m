...
% response to odor and in response to direct GC feedback
...
for i = 1:numOdors
    ...
    [spikeTrainRecord{2,i}, ~, ~, ~]  = simulator(network, mParam, gParam,...
        ...
        tauA_g, tauNr_g, tauNd_g, gAMPA, gNMDA,...
        tauAx_g, tauNrx_g, tauNdx_g, gAMPAx, gNMDAx);
    feedbackRecord{i} = gFeedback;
    fname = sprintf('GCdistributionR2.mat');
