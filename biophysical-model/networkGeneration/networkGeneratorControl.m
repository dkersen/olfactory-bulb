...
save('mitralCellsControl.mat', 'mitralArray','-v7.3');
save('fullNetworkControl.mat', 'network', '-v7.3');
save('granuleCellsControl.mat', 'granuleArray', '-v7.3');
save('glomeruliControl.mat', 'glomXYarray','-v7.3');
save('distanceControl.mat', 'distance','-v7.3');
