...
%Generates a network of MC and GCs (reduced GC:MC ratio)
...
save('mitralCellsImmortal.mat', 'mitralArray','-v7.3');
save('fullNetworkImmortal.mat', 'network', '-v7.3');
save('granuleCellsImmortal.mat', 'granuleArray', '-v7.3');
save('glomeruliImmortal.mat', 'glomXYarray','glomArray','-v7.3');
save('distanceImmortal.mat', 'distance','-v7.3');
